...
#define OMP_PARALLEL_FOR_SIMD PRAGMA(omp parallel for schedule(static) simd)
#define OMP_FOR PRAGMA(omp for schedule(static))
#define OMP_FOR_SIMD PRAGMA(omp for schedule(static) simd)
...
#define OMP_FOR_COLLAPSE(n) PRAGMA(omp parallel for collapse(n) schedule(static))
#define OMP_FOR_COLLAPSE2 OMP_FOR_COLLAPSE(2)
#define OMP_FOR_COLLAPSE3 OMP_FOR_COLLAPSE(3)
#define OMP_FOR_COLLAPSE4 OMP_FOR_COLLAPSE(4)
...
#if defined(__INTEL_COMPILER) && !defined(PRAGMA_SIMD)
